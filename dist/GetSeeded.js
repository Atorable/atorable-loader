...
var GetTorrentSeedAsync = function (assetRelPath, torRelPath, baseURL, rootContext) {
    return new Promise(function (resolve) {
        ...
        create_torrent_1.default(assetAbsoutePath, function (err, torrentBuf) {
            if (!err) {
                ...
                resolve({ torrent: magnetURI, torrentBuf: torrentBuf });
            }
            else {
                console.error(err);
            }
...
//# sourceMappingURL=GetSeeded.js.map